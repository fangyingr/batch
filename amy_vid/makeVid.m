function data_all = makeVid(sbj_names,project_name,concat_params,column,conds,norm_by_subj)
%% INPUTS
...
axis off
dir_out = [comp_root,'Results',filesep,project_name,filesep,'Group',filesep,'Vedio',filesep];
if ~exist(dir_out)
    mkdir(dir_out)
end
